...
public class LaserUfoActor extends Actor implements Disposable{
	...
	public LaserUfoActor() {
		laser = new Texture("laserRed07.png");
		miLaser = new TextureRegion(laser);
		//		laser = new TextureRegion(SpaceShooter.MANAGER.get("laserblue07.png",
//				Texture.class));
