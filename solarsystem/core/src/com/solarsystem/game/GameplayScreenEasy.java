...
//				}
	...
	private void spawnEnemigos(){
		...
		enemigo2.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 2), Actions.delay(3), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo7.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 2), Actions.delay(3), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo12.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 2), Actions.delay(3), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo17.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 2), Actions.delay(3), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo22.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 2), Actions.delay(3), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
	...
	private void spawnEnemigos2(){
		...
		enemigo4.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 2), Actions.delay(2.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo9.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 2), Actions.delay(2.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo14.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 2), Actions.delay(2.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo19.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 2), Actions.delay(2.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo24.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 2), Actions.delay(2.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
	...
	private void spawnEnemigos3(){
		...
		enemigo1.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 2), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo6.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 2), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo11.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 2), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
				Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo16.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 2), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo21.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 2), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
	...
	private void spawnEnemigos4(){
		...
		enemigo5.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 2), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo10.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 2), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo15.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 2), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo20.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 2), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
		enemigo25.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 2), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.delay(1.5f), Actions.moveBy(50, 0, 1.5f), Actions.delay(1.5f)))));
	...
	private void spawnEnemigosBlue(){
		...
		enemigoBlue1.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(3), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						 Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue5.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(3), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue9.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(3), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						 Actions.moveBy(0, -50, 1.5f), 
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue13.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(3), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue17.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(3), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
	...
	private void spawnEnemigosBlue2(){
		...
		enemigoBlue2.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(2.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue6.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(2.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue10.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(2.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f), 
						Actions.moveBy(50, 0, 1.5f),  
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue14.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(2.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue18.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(2.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
	...
	private void spawnEnemigosBlue3(){
		...
		enemigoBlue3.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue7.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue11.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue15.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f), 
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue19.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f), 
						Actions.moveBy(50, 0, 1.5f),  
						Actions.moveBy(0, 50, 1.5f)))));
	...
	private void spawnEnemigosBlue4(){
		...
		enemigoBlue4.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f),  
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue8.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f), 
						Actions.moveBy(50, 0, 1.5f),  
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue12.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue16.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
		enemigoBlue20.addAction(Actions.sequence(Actions.moveBy(0, -462, 2), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 1.5f), 
						Actions.moveBy(0, -50, 1.5f),
						Actions.moveBy(50, 0, 1.5f), 
						Actions.moveBy(0, 50, 1.5f)))));
	...
	private void spawnEnemigosYellow(){
		...
		enemigoYellow1.addAction(Actions.sequence(Actions.moveBy(720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,1.5f)))));

		enemigoYellow2.addAction(Actions.sequence(Actions.delay(0.25f), Actions.moveBy(720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,1.5f)))));
	
		enemigoYellow3.addAction(Actions.sequence(Actions.delay(0.50f), Actions.moveBy(720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,1.5f)))));
	
		enemigoYellow4.addAction(Actions.sequence(Actions.delay(0.75f), Actions.moveBy(720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,1.5f)))));

		enemigoYellow5.addAction(Actions.sequence(Actions.delay(1), Actions.moveBy(720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,1.5f)))));

		enemigoYellow6.addAction(Actions.sequence(Actions.delay(6), Actions.moveBy(-720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,1.5f)))));

		enemigoYellow7.addAction(Actions.sequence(Actions.delay(6.25f), Actions.moveBy(-720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,1.5f)))));

		enemigoYellow8.addAction(Actions.sequence(Actions.delay(6.5f), Actions.moveBy(-720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,1.5f)))));

		enemigoYellow9.addAction(Actions.sequence(Actions.delay(6.75f), Actions.moveBy(-720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,1.5f)))));

		enemigoYellow10.addAction(Actions.sequence(Actions.delay(7), Actions.moveBy(-720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,1.5f)))));

		enemigoYellow11.addAction(Actions.sequence(Actions.delay(12), Actions.moveBy(720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,1.5f)))));

		enemigoYellow12.addAction(Actions.sequence(Actions.delay(12.25f), Actions.moveBy(720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,1.5f)))));
	
		enemigoYellow13.addAction(Actions.sequence(Actions.delay(12.50f), Actions.moveBy(720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,1.5f)))));
	
		enemigoYellow14.addAction(Actions.sequence(Actions.delay(12.75f), Actions.moveBy(720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,1.5f)))));

		enemigoYellow15.addAction(Actions.sequence(Actions.delay(13), Actions.moveBy(720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,1.5f)))));
			

		enemigoYellow16.addAction(Actions.sequence(Actions.delay(18), Actions.moveBy(-720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,1.5f)))));

		enemigoYellow17.addAction(Actions.sequence(Actions.delay(18.25f), Actions.moveBy(-720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,1.5f)))));

		enemigoYellow18.addAction(Actions.sequence(Actions.delay(18.5f), Actions.moveBy(-720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,1.5f)))));

		enemigoYellow19.addAction(Actions.sequence(Actions.delay(18.75f), Actions.moveBy(-720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,1.5f)))));

		enemigoYellow20.addAction(Actions.sequence(Actions.delay(19), Actions.moveBy(-720,0,1.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 1.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,1.5f)))));
	...
	private void spawnEnemigosRed(){
	    ...
	    e.addAction(Actions.sequence(Actions.moveTo(nave.getRight()/2, nave.getTop()/2, 4),
	...
	private void spawnEnemigosStage6(){
		...
		enemigoStage63.setPosition(enemigoStage62.getX()+enemigoStage62.getWidth()+nave.getWidth()+40, stage.getHeight()+enemigoStage63.getHeight());
		...
		enemigosStage6.add(enemigoStage66);
			...
			enemigoStage61.addAction(Actions.sequence(Actions.moveBy(0, -250, 1), Actions.delay(1), 
					Actions.forever(Actions.sequence((Actions.moveBy(0, -600, 1))))));
	...
	private void spawnEnemigosStage63(){
		...
		enemigoStage62.setPosition(enemigoStage61.getWidth()+10+nave.getWidth()+40, stage.getHeight()+enemigoStage62.getHeight());
		enemigoStage62.getBb().setX(enemigoStage62.getX());
		enemigoStage62.getBb().setY(enemigoStage62.getY());
	...
	private void spawnEnemigosStage64(){
		...
		enemigoStage65.setPosition(enemigoStage64.getX()+enemigoStage64.getWidth()+20+nave.getWidth()+40, stage.getHeight()+enemigoStage65.getHeight());
		enemigoStage65.getBb().setX(enemigoStage65.getX());
		enemigoStage65.getBb().setY(enemigoStage65.getY());
	...
	private void spawnEnemigosStage65(){
		...
		enemigoStage63.setPosition(enemigoStage62.getX()+enemigoStage62.getWidth()+20+nave.getWidth()+40, stage.getHeight()+enemigoStage63.getHeight());
		enemigoStage63.getBb().setX(enemigoStage63.getX());
		enemigoStage63.getBb().setY(enemigoStage63.getY());
	...
	private void spawnEnemigosStage7(){
		...
		enemigoStage71.addAction(Actions.sequence(Actions.moveTo( 
				stage.getWidth()-enemigoStage71.getWidth()-50,100,2), Actions.moveTo( 
						stage.getWidth()-enemigoStage71.getWidth()-50,stage.getHeight()-enemigoStage71.getHeight()-100,2), Actions.moveTo( 
								50,stage.getHeight()-enemigoStage71.getHeight()-100,1),Actions.delay(8.5f),Actions.forever(
										Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));
		
		enemigoStage72.addAction(Actions.sequence(Actions.delay(0.2f),Actions.moveTo( 
				stage.getWidth()-enemigoStage72.getWidth()-50,100,2), Actions.moveTo( 
						stage.getWidth()-enemigoStage72.getWidth()-50,stage.getHeight()-enemigoStage72.getHeight()-100,2), Actions.moveTo( 
		...
		enemigoStage73.addAction(Actions.sequence(Actions.delay(0.4f),Actions.moveTo( 
				stage.getWidth()-enemigoStage73.getWidth()-50,100,2), Actions.moveTo( 
						stage.getWidth()-enemigoStage73.getWidth()-50,stage.getHeight()-enemigoStage73.getHeight()-100,2), Actions.moveTo( 
		...
		enemigoStage74.addAction(Actions.sequence(Actions.delay(0.6f),Actions.moveTo( 
				stage.getWidth()-enemigoStage74.getWidth()-50,100,2), Actions.moveTo( 
						stage.getWidth()-enemigoStage74.getWidth()-50,stage.getHeight()-enemigoStage74.getHeight()-100,2), Actions.moveTo( 
		...
		enemigoStage75.addAction(Actions.sequence(Actions.delay(0.8f),Actions.moveTo( 
				stage.getWidth()-enemigoStage75.getWidth()-50,100,2), Actions.moveTo( 
						stage.getWidth()-enemigoStage75.getWidth()-50,stage.getHeight()-enemigoStage75.getHeight()-100,2), Actions.moveTo( 
		...
		enemigoStage76.addAction(Actions.sequence(Actions.delay(4.5f),Actions.moveTo(
				50,100,2), Actions.moveTo(50,stage.getHeight()-enemigoStage76.getHeight()-200,1.5f),
				Actions.moveTo(stage.getWidth()-enemigoStage76.getWidth()-50, stage.getHeight()-enemigoStage76.getHeight()-200,1),Actions.delay(4.3f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));

		enemigoStage77.addAction(Actions.sequence(Actions.delay(4.7f),Actions.moveTo(
				50,100,2), Actions.moveTo(50,stage.getHeight()-enemigoStage77.getHeight()-200,1.5f),
				Actions.moveTo(stage.getWidth()-enemigoStage77.getWidth()-enemigoStage76.getWidth()-70, stage.getHeight()-enemigoStage77.getHeight()-200,0.8f),Actions.delay(4.3f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));

		enemigoStage78.addAction(Actions.sequence(Actions.delay(4.9f),Actions.moveTo(
				50,100,2), Actions.moveTo(50,stage.getHeight()-enemigoStage78.getHeight()-200,1.5f),
				Actions.moveTo(stage.getWidth()-enemigoStage78.getWidth()-enemigoStage77.getWidth()-enemigoStage76.getWidth()-90, stage.getHeight()-enemigoStage78.getHeight()-200,0.6f),Actions.delay(4.3f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));

		enemigoStage79.addAction(Actions.sequence(Actions.delay(5.1f),Actions.moveTo(
				50,100,2), Actions.moveTo(50,stage.getHeight()-enemigoStage79.getHeight()-200,1.5f),
				Actions.moveTo(stage.getWidth()-enemigoStage79.getWidth()-enemigoStage78.getWidth()-enemigoStage77.getWidth()-enemigoStage76.getWidth()-110, stage.getHeight()-enemigoStage79.getHeight()-200,0.4f),Actions.delay(4.3f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));

		enemigoStage80.addAction(Actions.sequence(Actions.delay(5.3f),Actions.moveTo(
				50,100,2), Actions.moveTo(50,stage.getHeight()-enemigoStage80.getHeight()-200,1.5f),
				Actions.moveTo(stage.getWidth()-enemigoStage80.getWidth()-enemigoStage79.getWidth()-enemigoStage78.getWidth()-enemigoStage77.getWidth()-enemigoStage76.getWidth()-130, stage.getHeight()-enemigoStage80.getHeight()-200,0.2f),Actions.delay(4.3f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));
	
		//Verdes
		
		enemigoStage81.addAction(Actions.sequence(Actions.delay(8.5f),Actions.moveTo(
				stage.getWidth()-enemigoStage81.getWidth()-50,stage.getHeight()-385,2), Actions.moveTo(50,stage.getHeight()-385,1),Actions.delay(1.8f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));

		enemigoStage82.addAction(Actions.sequence(Actions.delay(8.7f),Actions.moveTo(
				stage.getWidth()-enemigoStage82.getWidth()-50,stage.getHeight()-385,2), Actions.moveTo(50 + enemigoStage81.getWidth() + 20,stage.getHeight()-385,0.8f),Actions.delay(1.8f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));

		enemigoStage83.addAction(Actions.sequence(Actions.delay(8.9f),Actions.moveTo(
				stage.getWidth()-enemigoStage83.getWidth()-50,stage.getHeight()-385,2), Actions.moveTo(50 + enemigoStage81.getWidth() + enemigoStage82.getWidth() + 40,stage.getHeight()-385,0.6f),Actions.delay(1.8f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));

		enemigoStage84.addAction(Actions.sequence(Actions.delay(9.1f),Actions.moveTo(
				stage.getWidth()-enemigoStage84.getWidth()-50,stage.getHeight()-385,2), Actions.moveTo(50 + enemigoStage81.getWidth() + enemigoStage82.getWidth() + enemigoStage83.getWidth() + 60,stage.getHeight()-385,0.4f),Actions.delay(1.8f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));

		enemigoStage85.addAction(Actions.sequence(Actions.delay(9.3f),Actions.moveTo(
				stage.getWidth()-enemigoStage85.getWidth()-50,stage.getHeight()-385,2), Actions.moveTo(50 + enemigoStage81.getWidth() + enemigoStage82.getWidth() + enemigoStage83.getWidth() + enemigoStage84.getWidth() + 80,stage.getHeight()-385,0.2f),Actions.delay(1.8f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));

		//Amarillos
		
		enemigoStage86.addAction(Actions.sequence(Actions.delay(11.1f),Actions.moveTo(
				50,stage.getHeight()-485,1.5f), Actions.moveTo(stage.getWidth()-enemigoStage86.getWidth()-50, stage.getHeight()-485,1),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));
	
		enemigoStage87.addAction(Actions.sequence(Actions.delay(11.3f),Actions.moveTo(
				50,stage.getHeight()-485,1.5f), Actions.moveTo(stage.getWidth()-enemigoStage86.getWidth()-enemigoStage87.getWidth()-70, stage.getHeight()-485,0.8f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));
		
		enemigoStage88.addAction(Actions.sequence(Actions.delay(11.5f),Actions.moveTo(
				50,stage.getHeight()-485,1.5f), Actions.moveTo(stage.getWidth()-enemigoStage86.getWidth()-enemigoStage87.getWidth()-enemigoStage88.getWidth()-90, stage.getHeight()-485,0.6f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));
	
		enemigoStage89.addAction(Actions.sequence(Actions.delay(11.7f),Actions.moveTo(
				50,stage.getHeight()-485,1.5f), Actions.moveTo(stage.getWidth()-enemigoStage86.getWidth()-enemigoStage87.getWidth()-enemigoStage88.getWidth()-enemigoStage89.getWidth()-110, stage.getHeight()-485,0.4f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));

		enemigoStage90.addAction(Actions.sequence(Actions.delay(11.9f),Actions.moveTo(
				50,stage.getHeight()-485,1.5f), Actions.moveTo(stage.getWidth()-enemigoStage86.getWidth()-enemigoStage87.getWidth()-enemigoStage88.getWidth()-enemigoStage89.getWidth()-enemigoStage89.getWidth()-130, stage.getHeight()-485,0.2f),Actions.forever(
						Actions.sequence(Actions.moveBy(-50, 0, 0.8f),Actions.delay(0.6f),Actions.moveBy(50, 0, 0.8f),Actions.delay(0.6f)))));
