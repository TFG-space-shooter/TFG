...
public class GameplayScreenHard extends AbstractScreen{
	...
	public GameplayScreenHard(Solarsystem game) {
		super(game);		
...
//		}
		...
		for(int i = 0; i < enemigosStage6.size(); i++){
			if(enemigosStage6.get(i).getY() < -enemigosStage6.get(i).getHeight()){
				...
				puntuacion.setPuntuacion(puntuacion.getPuntuacion()+400);
			}
		}
		...
		for(int k = 0; k < meteoritos.size(); k++){
			...
			for(int j = 0; j < lasers.size(); j++){
				if(meteorito.getBb().overlaps(lasers.get(j).getBb())){
					...
					if(meteorito.getWidth()>=89&&meteorito.getContador()==80){
						...
						boom.setPosition(meteorito.getX()+meteorito.getWidth()/2-boom.getWidth()/2,
								meteorito.getY()+meteorito.getHeight()/2-boom.getHeight()/2);
						stage.addActor(boom);
						puntuacion.setPuntuacion(puntuacion.getPuntuacion()+2000);
					}else if(meteorito.getWidth()==43&&meteorito.getContador()==40){
						meteoritos.get(k).remove();
						meteoritos.remove(k);
						BoomActor boom = new BoomActor();
						boom.setPosition(meteorito.getX()+meteorito.getWidth()/2-boom.getWidth()/2,
					...
					}else if(meteorito.getWidth()==29&&meteorito.getContador()==20){
						meteoritos.get(k).remove();
						meteoritos.remove(k);
						BoomActor boom = new BoomActor();
						boom.setPosition(meteorito.getX()+meteorito.getWidth()/2-boom.getWidth()/2,
...
//				}
			...
			if(enemigoGreen.getBb().overlaps(nave.getBb())&&
				...
				for(int j = 0; j < lasers.size(); j++){
					...
					if(laser.getBb().overlaps(enemigoGreen.getBb())){
						...
						if(enemigoGreen.getContador()==13){
							Random random = new Random();
						    int index = random.nextInt(booleans.size());
						    Boolean m = booleans.get(index);
						    if(m){
				...
				if(enemigoYellow.getBb().overlaps(nave.getBb())&&
					...
					for(int j = 0; j < lasers.size(); j++){
						...
						if(laser.getBb().overlaps(enemigoYellow.getBb())){
							...
							if(enemigoYellow.getContador()==20){
								Random random = new Random();
							    int index = random.nextInt(booleans.size());
							    Boolean m = booleans.get(index);
							    if(m){
				...
				if(enemigoStage7.getBb().overlaps(nave.getBb())&&
					...
					for(int j = 0; j < lasers.size(); j++){
						...
						if(laser.getBb().overlaps(enemigoStage7.getBb())){
							...
							if(enemigoStage7.getContador()==25){
								Random random = new Random();
							    int index = random.nextInt(booleans.size());
							    Boolean m = booleans.get(index);
							    if(m){
					...
					if(laser.getBb().overlaps(jefe.getBb())){
						...
						if(jefe.getContador()>=2000){
							...
							if(contador10000<1){
								...
								puntuacion.setPuntuacion(puntuacion.getPuntuacion()+40000);
								contador10000 =10000;
	...
	private void spawnEnemigos(){
		...
		enemigo2.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 1), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo7.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 1), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo12.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 1), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo17.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 1), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo22.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 1), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
	...
	private void spawnEnemigos2(){
		...
		enemigo4.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 1), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo9.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 1), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo14.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 1), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo19.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 1), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo24.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 1), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
	...
	private void spawnEnemigos3(){
		...
		enemigo1.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 1), Actions.delay(1), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo6.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 1), Actions.delay(1), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo11.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 1), Actions.delay(1), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo16.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 1), Actions.delay(1), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0,0.5f), Actions.delay(0.5f)))));
		enemigo21.addAction(Actions.sequence(Actions.moveBy(-720+75, 0, 1), Actions.delay(1), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
	...
	private void spawnEnemigos4(){
		...
		enemigo5.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 1), Actions.delay(0.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo10.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 1), Actions.delay(0.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo15.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 1), Actions.delay(0.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo20.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 1), Actions.delay(0.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
		enemigo25.addAction(Actions.sequence(Actions.moveBy(720-75, 0, 1), Actions.delay(0.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.delay(0.5f), Actions.moveBy(50, 0, 0.5f), Actions.delay(0.5f)))));
	...
	private void spawnEnemigosBlue(){
		...
		enemigoBlue1.addAction(Actions.sequence(Actions.moveBy(0, -462,1), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						 Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue5.addAction(Actions.sequence(Actions.moveBy(0, -462,1), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue9.addAction(Actions.sequence(Actions.moveBy(0, -462,1), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						 Actions.moveBy(0, -50, 0.5f), 
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue13.addAction(Actions.sequence(Actions.moveBy(0, -462,1), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue17.addAction(Actions.sequence(Actions.moveBy(0, -462,1), Actions.delay(2), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
	...
	private void spawnEnemigosBlue2(){
		...
		enemigoBlue2.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue6.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue10.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f), 
						Actions.moveBy(50, 0, 0.5f),  
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue14.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue18.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(1.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
	...
	private void spawnEnemigosBlue3(){
		...
		enemigoBlue3.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(1), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue7.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(1), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue11.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(1), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue15.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(1), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f), 
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue19.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(1), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f), 
						Actions.moveBy(50, 0, 0.5f),  
						Actions.moveBy(0, 50, 0.5f)))));
	...
	private void spawnEnemigosBlue4(){
		...
		enemigoBlue4.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(0.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f),  
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue8.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(0.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f), 
						Actions.moveBy(50, 0, 0.5f),  
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue12.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(0.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue16.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(0.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
		enemigoBlue20.addAction(Actions.sequence(Actions.moveBy(0, -462, 1), Actions.delay(0.5f), 
				Actions.forever(Actions.sequence(Actions.moveBy(-50, 0, 0.5f), 
						Actions.moveBy(0, -50, 0.5f),
						Actions.moveBy(50, 0, 0.5f), 
						Actions.moveBy(0, 50, 0.5f)))));
	...
	private void spawnEnemigosYellow(){
		...
		enemigoYellow1.addAction(Actions.sequence(Actions.moveBy(720,0,0.5f),
		...
		enemigoYellow2.addAction(Actions.sequence(Actions.delay(0.25f), Actions.moveBy(720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,0.5f)))));
	
		enemigoYellow3.addAction(Actions.sequence(Actions.delay(0.50f), Actions.moveBy(720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,0.5f)))));
	
		enemigoYellow4.addAction(Actions.sequence(Actions.delay(0.75f), Actions.moveBy(720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,0.5f)))));
		...
		enemigoYellow6.addAction(Actions.sequence(Actions.delay(6), Actions.moveBy(-720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,0.5f)))));

		enemigoYellow7.addAction(Actions.sequence(Actions.delay(6.25f), Actions.moveBy(-720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,0.5f)))));

		enemigoYellow8.addAction(Actions.sequence(Actions.delay(6.5f), Actions.moveBy(-720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,0.5f)))));

		enemigoYellow9.addAction(Actions.sequence(Actions.delay(6.75f), Actions.moveBy(-720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,0.5f)))));

		enemigoYellow10.addAction(Actions.sequence(Actions.delay(7), Actions.moveBy(-720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,0.5f)))));

		enemigoYellow11.addAction(Actions.sequence(Actions.delay(12), Actions.moveBy(720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,0.5f)))));

		enemigoYellow12.addAction(Actions.sequence(Actions.delay(12.25f), Actions.moveBy(720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,0.5f)))));
	
		enemigoYellow13.addAction(Actions.sequence(Actions.delay(12.50f), Actions.moveBy(720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,0.5f)))));
	
		enemigoYellow14.addAction(Actions.sequence(Actions.delay(12.75f), Actions.moveBy(720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,0.5f)))));

		enemigoYellow15.addAction(Actions.sequence(Actions.delay(13), Actions.moveBy(720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627,0,0.5f)))));
			

		enemigoYellow16.addAction(Actions.sequence(Actions.delay(18), Actions.moveBy(-720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,0.5f)))));

		enemigoYellow17.addAction(Actions.sequence(Actions.delay(18.25f), Actions.moveBy(-720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,0.5f)))));

		enemigoYellow18.addAction(Actions.sequence(Actions.delay(18.5f), Actions.moveBy(-720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,0.5f)))));

		enemigoYellow19.addAction(Actions.sequence(Actions.delay(18.75f), Actions.moveBy(-720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,0.5f)))));

		enemigoYellow20.addAction(Actions.sequence(Actions.delay(19), Actions.moveBy(-720,0,0.5f),
				Actions.forever(Actions.sequence(Actions.moveBy(0, -100, 0.2f), Actions.moveBy(627, 0, 0.5f),
				Actions.moveBy(0, -100, 0.2f), Actions.moveBy(-627,0,0.5f)))));
	...
	private void spawnJefe(){
		...
		jefe.addAction(Actions.sequence(Actions.moveTo(stage.getWidth()/2-jefe.getWidth()/2, 
				stage.getHeight()-100-jefe.getHeight(), 4),  Actions.delay(2), Actions.moveTo(50, stage.getHeight()-100-jefe.getHeight(), 1),  Actions.forever(
						Actions.sequence(Actions.delay(0.1f),Actions.moveTo(stage.getWidth()-jefe.getWidth()-50, stage.getHeight()-100-jefe.getHeight(), 1.5f),Actions.delay(0.1f), Actions.moveTo(50, stage.getHeight()-100-jefe.getHeight(), 1.5f)))));
	...
	private void dispararJefe(){
		if(stage.getActors().contains(jefe, false)){
			...
			laserJefe1.addAction(Actions.forever(
					Actions.moveBy(0.5f, -700 * Gdx.graphics.getDeltaTime())));
	...
	private void dispararJefe2(){
		if(stage.getActors().contains(jefe, false)){
			...
			laserJefe3.addAction(Actions.forever(
					Actions.moveBy(700 * Gdx.graphics.getDeltaTime(), 700 * Gdx.graphics.getDeltaTime())));
			laserJefe4.addAction(Actions.forever(
					Actions.moveBy(700 * Gdx.graphics.getDeltaTime(), 700 * Gdx.graphics.getDeltaTime())));
			laserJefe5.addAction(Actions.forever(
					Actions.moveBy(700 * Gdx.graphics.getDeltaTime(), 0)));
	...
	private void dispararJefe3(){
		if(stage.getActors().contains(jefe, false)){
			...
			laserJefe2.addAction(Actions.forever(
					Actions.moveBy(0, -700 * Gdx.graphics.getDeltaTime())));
			laserJefe3.addAction(Actions.forever(
					Actions.moveBy(250 * Gdx.graphics.getDeltaTime(), -700 * Gdx.graphics.getDeltaTime())));
			laserJefe4.addAction(Actions.forever(
					Actions.moveBy(250 * Gdx.graphics.getDeltaTime(), -700 * Gdx.graphics.getDeltaTime())));
			laserJefe5.addAction(Actions.forever(
					Actions.moveBy(-250 * Gdx.graphics.getDeltaTime(), -700 * Gdx.graphics.getDeltaTime())));
	...
	private void dispararLaserEnemigoBlue(){
		...
		laserEnemigos.add(laserEnemigo);
		laserEnemigo.addAction(Actions.forever(
				Actions.moveBy(0, -750 * Gdx.graphics.getDeltaTime())));
	...
	private void dispararLaserEnemigoYellow(){
		...
		laserEnemigos.add(laserEnemigo);
		laserEnemigo.addAction(Actions.forever(
				Actions.moveBy(0, -800 * Gdx.graphics.getDeltaTime())));
	...
	private void dispararLaserEnemigoRed(){
		...
		laserEnemigos.add(laserEnemigo);
		laserEnemigo.addAction(Actions.forever(
				Actions.moveBy(0, -850 * Gdx.graphics.getDeltaTime())));
	...
	private void dispararLaserEnemigoStage7(){
		...
		laserEnemigos.add(laserEnemigo);
		laserEnemigo.addAction(Actions.forever(
				Actions.moveBy(0, -1000 * Gdx.graphics.getDeltaTime())));
...
//		ufos.add(ufo);
	...
	private void spawnMeteorito(){
		...
		meteorito.addAction(Actions.forever(Actions.parallel(
				Actions.moveBy(vx*delta, -200*delta),Actions.rotateBy(rx))));
